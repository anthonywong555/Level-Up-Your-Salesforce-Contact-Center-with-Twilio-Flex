...
/**
 * This function allow user to upsert Record(s) inside Salesforce
 * Reference: https://jsforce.github.io/document/#upsert
 */

const SERVERLESS_FILE_PATH = '/sfdc/crud/upsert';
...
const driver = async (serverlessContext, serverlessEvent, serverlessHelper, twilioClient) => {
  try {
    const actionType = serverlessHelper.sfdc.constants.ACTION_SOBJECT_UPSERT;
